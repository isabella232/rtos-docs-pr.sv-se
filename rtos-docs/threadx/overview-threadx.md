...
* Preemption-Threshold – Unikt för Azure RTOS ThreadX, hjälper till att minska kontextväxlar och bidrar till att garantera schedulability (per akademisk forskning)
...
* Optimerad timer som avbryter bearbetning
