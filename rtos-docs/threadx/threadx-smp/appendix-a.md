...
---
# <a name="appendix-a---azure-rtos-threadx-smp-api-services"></a>Bilaga A – Azure återställnings tider ThreadX SMP API-tjänster
...
```
## <a name="mutex-services"></a>Mutex-tjänster
