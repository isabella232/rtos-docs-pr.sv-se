---
title: Bilaga A – Azure återställnings tider ThreadX SMP API-tjänster
description: ThreadX SMP API-tjänster
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104827342"
---
# <a name="appendix-a---azure-rtos-threadx-smp-api-services"></a><span data-ttu-id="b2a24-103">Bilaga A – Azure återställnings tider ThreadX SMP API-tjänster</span><span class="sxs-lookup"><span data-stu-id="b2a24-103">Appendix A - Azure RTOS ThreadX SMP API Services</span></span>

## <a name="entry-function"></a><span data-ttu-id="b2a24-104">Post funktion</span><span class="sxs-lookup"><span data-stu-id="b2a24-104">Entry Function</span></span>

```C
VOID     tx_kernel_enter(VOID);
```
## <a name="block-memory-services"></a><span data-ttu-id="b2a24-105">Blockera minnes tjänster</span><span class="sxs-lookup"><span data-stu-id="b2a24-105">Block Memory Services</span></span>
...
```
## <a name="byte-memory-services"></a><span data-ttu-id="b2a24-106">Byte minnes tjänster</span><span class="sxs-lookup"><span data-stu-id="b2a24-106">Byte Memory Services</span></span>
...
```
## <a name="event-flags-services"></a><span data-ttu-id="b2a24-107">Event Flags-tjänster</span><span class="sxs-lookup"><span data-stu-id="b2a24-107">Event Flags Services</span></span>
...
UINT     tx_event_flags_set_notify(TX_EVENT_FLAGS_GROUP
            ...
            *));
```
## <a name="interrupt-control"></a><span data-ttu-id="b2a24-108">Avbrotts kontroll</span><span class="sxs-lookup"><span data-stu-id="b2a24-108">Interrupt Control</span></span>

```C
UINT     tx_interrupt_control(UINT new_posture);
```
## <a name="mutex-services"></a><span data-ttu-id="b2a24-109">Mutex-tjänster</span><span class="sxs-lookup"><span data-stu-id="b2a24-109">Mutex Services</span></span>
...
```
## <a name="queue-services"></a><span data-ttu-id="b2a24-110">Queue Services</span><span class="sxs-lookup"><span data-stu-id="b2a24-110">Queue Services</span></span>
...
```
## <a name="semaphore-services"></a><span data-ttu-id="b2a24-111">Semafor-tjänster</span><span class="sxs-lookup"><span data-stu-id="b2a24-111">Semaphore Services</span></span>
...
UINT     tx_semaphore_put_notify(TX_SEMAPHORE
            ...
            *));
```
## <a name="thread-control-services"></a><span data-ttu-id="b2a24-112">Tråd kontroll tjänster</span><span class="sxs-lookup"><span data-stu-id="b2a24-112">Thread Control Services</span></span>
...
```
## <a name="time-services"></a><span data-ttu-id="b2a24-113">Tids tjänster</span><span class="sxs-lookup"><span data-stu-id="b2a24-113">Time Services</span></span>

```C
ULONG     tx_time_get(VOID);
VOID      tx_time_set(ULONG new_time);
```
## <a name="timer-services"></a><span data-ttu-id="b2a24-114">Timer-tjänster</span><span class="sxs-lookup"><span data-stu-id="b2a24-114">Timer Services</span></span>
