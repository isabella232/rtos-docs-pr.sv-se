---
title: Bilaga A – Azure RTOS ThreadX SMP API Services
...
ms.locfileid: "116798851"
---
# <a name="appendix-a---azure-rtos-threadx-smp-api-services"></a>Bilaga A – Azure RTOS ThreadX SMP API Services
