---
title: Bilaga B – Azure RTOS ThreadX-konstanter
description: Utforska de Azure RTOS ThreadX-konstanterna.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "116801859"
---
# <a name="appendix-b---azure-rtos-threadx-constants"></a>Bilaga B – Azure RTOS ThreadX-konstanter

- [**Alfabetiska listor**](#alphabetic-listings) 
- [**Lista efter värde**](#listing-by-value)

## <a name="alphabetic-listings"></a>Alfabetiska listor
...
## <a name="listing-by-value"></a>Lista efter värde

| Konstant (efter värde) | Värde  |
| ------------- | - |
| TX_DONT_START | 0 |
| TX_FALSE | 0 |
| TX_NO_ACTIVATE | 0 |
