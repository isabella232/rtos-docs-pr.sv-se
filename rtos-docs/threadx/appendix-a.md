...
---
# <a name="appendix-a---azure-rtos-threadx-api-services"></a><span data-ttu-id="b56a8-103">Bilaga A – Azure återställnings tider ThreadX API-tjänster</span><span class="sxs-lookup"><span data-stu-id="b56a8-103">Appendix A - Azure RTOS ThreadX API Services</span></span>

## <a name="entry-function"></a><span data-ttu-id="b56a8-104">Post funktion</span><span class="sxs-lookup"><span data-stu-id="b56a8-104">Entry Function</span></span>

```c
VOID      tx_kernel_enter(VOID);
```

## <a name="block-memory-services"></a><span data-ttu-id="b56a8-105">Blockera minnes tjänster</span><span class="sxs-lookup"><span data-stu-id="b56a8-105">Block Memory Services</span></span>
...
## <a name="byte-memory-services"></a><span data-ttu-id="b56a8-106">Byte minnes tjänster</span><span class="sxs-lookup"><span data-stu-id="b56a8-106">Byte Memory Services</span></span>
...
## <a name="event-flags-services"></a><span data-ttu-id="b56a8-107">Event Flags-tjänster</span><span class="sxs-lookup"><span data-stu-id="b56a8-107">Event Flags Services</span></span>
...
## <a name="interrupt-control"></a><span data-ttu-id="b56a8-108">Avbrotts kontroll</span><span class="sxs-lookup"><span data-stu-id="b56a8-108">Interrupt Control</span></span>

```c
UINT      tx_interrupt_control(UINT new_posture);
```

## <a name="mutex-services"></a><span data-ttu-id="b56a8-109">Mutex-tjänster</span><span class="sxs-lookup"><span data-stu-id="b56a8-109">Mutex Services</span></span>
...
```
## <a name="queue-services"></a><span data-ttu-id="b56a8-110">Queue Services</span><span class="sxs-lookup"><span data-stu-id="b56a8-110">Queue Services</span></span>
...
## <a name="semaphore-services"></a><span data-ttu-id="b56a8-111">Semafor-tjänster</span><span class="sxs-lookup"><span data-stu-id="b56a8-111">Semaphore Services</span></span>
...
## <a name="thread-control-services"></a><span data-ttu-id="b56a8-112">Tråd kontroll tjänster</span><span class="sxs-lookup"><span data-stu-id="b56a8-112">Thread Control Services</span></span>
...
## <a name="time-services"></a><span data-ttu-id="b56a8-113">Tids tjänster</span><span class="sxs-lookup"><span data-stu-id="b56a8-113">Time Services</span></span>
...
## <a name="timer-services"></a><span data-ttu-id="b56a8-114">Timer-tjänster</span><span class="sxs-lookup"><span data-stu-id="b56a8-114">Timer Services</span></span>
