...
---
# <a name="appendix-c---azure-rtos-snetx-duo-data-types"></a><span data-ttu-id="99436-103">Bilaga C – Azure återställnings tider sNetX Duo-datatyper</span><span class="sxs-lookup"><span data-stu-id="99436-103">Appendix C - Azure RTOS sNetX Duo Data Types</span></span>

## <a name="nx_arp"></a><span data-ttu-id="99436-104">NX_ARP</span><span class="sxs-lookup"><span data-stu-id="99436-104">NX_ARP</span></span>
...
```
## <a name="nx_interface"></a><span data-ttu-id="99436-105">NX_INTERFACE;</span><span class="sxs-lookup"><span data-stu-id="99436-105">NX_INTERFACE;</span></span>
...
```
## <a name="nx_ip"></a><span data-ttu-id="99436-106">NX_IP</span><span class="sxs-lookup"><span data-stu-id="99436-106">NX_IP</span></span>
...
```
## <a name="nx_ip_driver"></a><span data-ttu-id="99436-107">NX_IP_DRIVER</span><span class="sxs-lookup"><span data-stu-id="99436-107">NX_IP_DRIVER</span></span>
...
```
## <a name="nx_ip_routing_entry"></a><span data-ttu-id="99436-108">NX_IP_ROUTING_ENTRY</span><span class="sxs-lookup"><span data-stu-id="99436-108">NX_IP_ROUTING_ENTRY</span></span>
...
```
## <a name="nx_ipv6_default_router_entry"></a><span data-ttu-id="99436-109">NX_IPV6_DEFAULT_ROUTER_ENTRY</span><span class="sxs-lookup"><span data-stu-id="99436-109">NX_IPV6_DEFAULT_ROUTER_ENTRY</span></span>
...
#endif /* FEATURE_NX_IPV6 */
```
## <a name="nx_ipv6_prefix_entry"></a><span data-ttu-id="99436-110">NX_IPV6_PREFIX_ENTRY</span><span class="sxs-lookup"><span data-stu-id="99436-110">NX_IPV6_PREFIX_ENTRY</span></span>
...
```
## <a name="nx_packet"></a><span data-ttu-id="99436-111">NX_PACKET</span><span class="sxs-lookup"><span data-stu-id="99436-111">NX_PACKET</span></span>
...
```
## <a name="nx_packet_pool"></a><span data-ttu-id="99436-112">NX_PACKET_POOL</span><span class="sxs-lookup"><span data-stu-id="99436-112">NX_PACKET_POOL</span></span>
...
```
## <a name="nx_tcp_listen"></a><span data-ttu-id="99436-113">NX_TCP_LISTEN</span><span class="sxs-lookup"><span data-stu-id="99436-113">NX_TCP_LISTEN</span></span>
...
```
## <a name="nx_tcp_socket"></a><span data-ttu-id="99436-114">NX_TCP_SOCKET</span><span class="sxs-lookup"><span data-stu-id="99436-114">NX_TCP_SOCKET</span></span>
...
```
## <a name="nx_udp_socket"></a><span data-ttu-id="99436-115">NX_UDP_SOCKET</span><span class="sxs-lookup"><span data-stu-id="99436-115">NX_UDP_SOCKET</span></span>
...
```
## <a name="nxd_ipv6_address"></a><span data-ttu-id="99436-116">NXD_IPV6_ADDRESS</span><span class="sxs-lookup"><span data-stu-id="99436-116">NXD_IPV6_ADDRESS</span></span>
...
```
## <a name="nxd_address"></a><span data-ttu-id="99436-117">NXD_ADDRESS</span><span class="sxs-lookup"><span data-stu-id="99436-117">NXD_ADDRESS</span></span>
