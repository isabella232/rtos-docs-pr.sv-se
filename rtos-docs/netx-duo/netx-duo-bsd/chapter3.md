...
---
# <a name="chapter-3---azure-rtos-netx-duo-bsd-services"></a><span data-ttu-id="bb7b9-103">Kapitel 3 – Azure återställnings tider NetX Duo BSD-tjänster</span><span class="sxs-lookup"><span data-stu-id="bb7b9-103">Chapter 3 - Azure RTOS NetX Duo BSD Services</span></span>

<span data-ttu-id="bb7b9-104">Det här kapitlet innehåller en beskrivning av alla Azure återställnings tider NetX Duo BSD Basic-tjänster (visas nedan) i alfabetisk ordning.</span><span class="sxs-lookup"><span data-stu-id="bb7b9-104">This chapter contains a description of all Azure RTOS NetX Duo BSD basic services (listed below) in alphabetic order.</span></span>
