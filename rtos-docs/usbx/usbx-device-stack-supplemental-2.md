...
<span data-ttu-id="f66ba-113">För CDC-ECM kräver RNDIS-klassen 2 noder, en lokal och en fjärr anslutning, men det finns inget krav på att ha en sträng beskrivning som beskriver fjärrnoden.</span><span class="sxs-lookup"><span data-stu-id="f66ba-113">As for the CDC-ECM, the RNDIS class requires 2 nodes, one local and one remote but there is no requirement to have a string descriptor describing the remote node.</span></span>
...
<span data-ttu-id="f66ba-144">En DFU Device Framework ser ut så här.</span><span class="sxs-lookup"><span data-stu-id="f66ba-144">A DFU device framework will look like this.</span></span>
...
<span data-ttu-id="f66ba-180">Nedan visas en beskrivning av ett typiskt DFU-programflöde.</span><span class="sxs-lookup"><span data-stu-id="f66ba-180">Following is the description of a typical DFU application flow.</span></span>
...
<span data-ttu-id="f66ba-206">USB-enhetens PIMA-klass tillåter att ett USB-värdnamn (Initiator) ansluter till en</span><span class="sxs-lookup"><span data-stu-id="f66ba-206">The USB device PIMA class allows for a USB host system (Initiator) to connect to a</span></span>
...
| <span data-ttu-id="f66ba-265">UX_DEVICE_CLASS_PIMA_EC_OBJECT_ADDED</span><span class="sxs-lookup"><span data-stu-id="f66ba-265">UX_DEVICE_CLASS_PIMA_EC_OBJECT_ADDED</span></span>             | <span data-ttu-id="f66ba-266">0x4002</span><span class="sxs-lookup"><span data-stu-id="f66ba-266">0x4002</span></span>  | <span data-ttu-id="f66ba-267">Ett objekt har lagts till i enhets mediet och kan hämtas av host\.</span><span class="sxs-lookup"><span data-stu-id="f66ba-267">An object has been added to the device media and can be retrieved by the host\.</span></span> |
...
<span data-ttu-id="f66ba-323">Lägga till ett objekt och skicka händelsen till värden</span><span class="sxs-lookup"><span data-stu-id="f66ba-323">Adding an object and sending the event to the host</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-343">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-343">Description</span></span>
...
### <a name="example"></a><span data-ttu-id="f66ba-361">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-361">Example</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-365">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-365">Description</span></span>
...
## <a name="ux_device_class_pima_object_info_send"></a><span data-ttu-id="f66ba-374">ux_device_class_pima_object_info_send</span><span class="sxs-lookup"><span data-stu-id="f66ba-374">ux_device_class_pima_object_info_send</span></span>
...
## <a name="ux_device_class_pima_object_data_send"></a><span data-ttu-id="f66ba-384">ux_device_class_pima_object_data_send</span><span class="sxs-lookup"><span data-stu-id="f66ba-384">ux_device_class_pima_object_data_send</span></span>
...
## <a name="ux_device_class_pima_object_delete"></a><span data-ttu-id="f66ba-397">ux_device_class_pima_object_delete</span><span class="sxs-lookup"><span data-stu-id="f66ba-397">ux_device_class_pima_object_delete</span></span>

<span data-ttu-id="f66ba-398">Ta bort ett lokalt objekt</span><span class="sxs-lookup"><span data-stu-id="f66ba-398">Delete a local object</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-399">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-399">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-400">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-400">Description</span></span>

<span data-ttu-id="f66ba-401">Den här funktionen anropas när PIMA-klassen behöver ta bort ett objekt i den lokala lagringen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-401">This function is called when the PIMA class needs to delete an object on the local storage.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-402">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-402">Parameters</span></span>

- <span data-ttu-id="f66ba-403">**Pima**: pekar mot Pima-klass instansen</span><span class="sxs-lookup"><span data-stu-id="f66ba-403">**pima**: Pointer to the pima class instance</span></span>
- <span data-ttu-id="f66ba-404">**object_handle**: referens för objektet</span><span class="sxs-lookup"><span data-stu-id="f66ba-404">**object_handle**: Handle of the object</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-405">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-405">Example</span></span>
...
## <a name="usb-device-audio-class"></a><span data-ttu-id="f66ba-406">Ljud klass för USB-enhet</span><span class="sxs-lookup"><span data-stu-id="f66ba-406">USB Device Audio Class</span></span>

<span data-ttu-id="f66ba-407">Ljud klassen USB-enhet gör att ett USB-värdnamn kan kommunicera med enheten som en ljuden het.</span><span class="sxs-lookup"><span data-stu-id="f66ba-407">The USB device Audio class allows for a USB host system to communicate with the device as an audio device.</span></span> <span data-ttu-id="f66ba-408">Den här klassen baseras på USB-standarden och USB Audio-klassen 1,0 eller 2,0 standard.</span><span class="sxs-lookup"><span data-stu-id="f66ba-408">This class is based on the USB standard and USB Audio Class 1.0 or 2.0 standard.</span></span>

<span data-ttu-id="f66ba-409">En USB-kompatibel enhets ramverk måste deklareras av enhets stacken.</span><span class="sxs-lookup"><span data-stu-id="f66ba-409">A USB audio compliant device framework needs to be declared by the device stack.</span></span> <span data-ttu-id="f66ba-410">Ett exempel på en ljud 2,0-talare följer:</span><span class="sxs-lookup"><span data-stu-id="f66ba-410">An example of an Audio 2.0 speaker follows:</span></span>
...
<span data-ttu-id="f66ba-411">Klassen Audio använder ett sammansatt enhets ramverk för att gruppera gränssnitt (kontroll och strömning).</span><span class="sxs-lookup"><span data-stu-id="f66ba-411">The Audio class uses a composite device framework to group interfaces (control and streaming).</span></span> <span data-ttu-id="f66ba-412">Därför bör du vidta åtgärder när du definierar enhets beskrivningen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-412">As a result care should be taken when defining the device descriptor.</span></span> <span data-ttu-id="f66ba-413">USBX förlitar sig på IAD-beskrivningen för att veta internt hur man binder gränssnitt.</span><span class="sxs-lookup"><span data-stu-id="f66ba-413">USBX relies on the IAD descriptor to know internally how to bind interfaces.</span></span> <span data-ttu-id="f66ba-414">IAD-beskrivningen måste deklareras före gränssnitten (ett AudioControl-gränssnitt följt av ett eller flera AudioStreaming-gränssnitt) och innehålla det första gränssnittet i klassen Audio (AudioControl-gränssnittet) och hur många gränssnitt som är kopplade.</span><span class="sxs-lookup"><span data-stu-id="f66ba-414">The IAD descriptor should be declared before the interfaces (an AudioControl interface followed by one or more AudioStreaming interfaces) and contain the first interface of the Audio class (the AudioControl interface) and how many interfaces are attached.</span></span>

<span data-ttu-id="f66ba-415">Hur klassen Audio fungerar beror på om enheten skickar eller tar emot ljud, men båda fallen använder en FIFO för att lagra ljud Rams buffertar: om enheten skickar ljud till värden, lägger programmet till ljud Rams buffertar till FIFO som senare skickas till värden av USBX; Om enheten tar emot ljud från värden lägger USBX till de ljud Rams buffertar som tas emot från värden till FIFO-enheten som senare läses av programmet.</span><span class="sxs-lookup"><span data-stu-id="f66ba-415">The way the audio class works depends on whether the device is sending or receiving audio, but both cases use a FIFO for storing audio frame buffers: if the device is sending audio to the host, then the application adds audio frame buffers to the FIFO which are later sent to the host by USBX; if the device is receiving audio from the host, then USBX adds the audio frame buffers received from the host to the FIFO which are later read by the application.</span></span> <span data-ttu-id="f66ba-416">Varje ljud ström har en egen FIFO, och varje buffert för ljud ramar består av flera exempel.</span><span class="sxs-lookup"><span data-stu-id="f66ba-416">Each audio stream has its own FIFO, and each audio frame buffer consists of multiple samples.</span></span>

<span data-ttu-id="f66ba-417">Initieringen av klassen Audio förväntar sig följande delar.</span><span class="sxs-lookup"><span data-stu-id="f66ba-417">The initialization of the Audio class expects the following parts.</span></span>

1. <span data-ttu-id="f66ba-418">Klassen Audio förväntar sig följande strömnings parametrar:</span><span class="sxs-lookup"><span data-stu-id="f66ba-418">Audio class expects the following streaming parameters:</span></span>
...
2. <span data-ttu-id="f66ba-419">Klassen Audio förväntar sig följande funktions parametrar.</span><span class="sxs-lookup"><span data-stu-id="f66ba-419">Audio class expects the following function parameters.</span></span>
   ...
   */
   ...
   <span data-ttu-id="f66ba-420">Den programdefinierade kontrollen begär motringning (***ux_device_class_audio_control_process***; som anges i föregående exempel) anropas när stacken tar emot en kontrollbegäran från värden.</span><span class="sxs-lookup"><span data-stu-id="f66ba-420">The application-defined control request callback (***ux_device_class_audio_control_process***; set in the previous example) is invoked when the stack receives a control request from the host.</span></span> <span data-ttu-id="f66ba-421">Om begäran godkänns och hanteras (bekräftas eller stoppas) måste återanropet returnera ett fel, annars ska felet returneras.</span><span class="sxs-lookup"><span data-stu-id="f66ba-421">If the request is accepted and handled (acknowledged or stalled) the callback must return success, otherwise error should be returned.</span></span>

   <span data-ttu-id="f66ba-422">Den klassbaserade kontrollen begär processen definieras som en programdefinierad motringning eftersom kontroll förfrågningarna är mycket olika mellan USB-ljudversioner och en stor del av processen för begäran relaterar till enhets ramverket.</span><span class="sxs-lookup"><span data-stu-id="f66ba-422">The class-specific control request process is defined as an application-defined callback because the control requests are very different between USB Audio versions and a large part of the request process relates to the device framework.</span></span> <span data-ttu-id="f66ba-423">Programmet ska hantera begär Anden korrekt för att enheten ska fungera.</span><span class="sxs-lookup"><span data-stu-id="f66ba-423">The application should handle requests correctly to make the device functional.</span></span>

   <span data-ttu-id="f66ba-424">Eftersom en ljuden het, volym, ljud av och samplings frekvens är vanliga kontroll begär Anden, är det enkelt att använda internt definierade återanrop för olika versioner av USB-ljud i senare avsnitt för program som ska användas.</span><span class="sxs-lookup"><span data-stu-id="f66ba-424">Since for an audio device, volume, mute and sampling frequency are common control requests, simple, internally-defined callbacks for different USB audio versions are introduced in later sections for applications to use.</span></span> <span data-ttu-id="f66ba-425">Se ***ux_device_class_audio10_control_process** _ och _ *_ux_device_class_audio_control_request_** för mer information.</span><span class="sxs-lookup"><span data-stu-id="f66ba-425">Refer to ***ux_device_class_audio10_control_process** _ and _ *_ux_device_class_audio_control_request_** for more details.</span></span>

<span data-ttu-id="f66ba-426">I enhets ramverket för ljud enheten lagras PID/VID i enhets beskrivningen (se den enhets beskrivning som anges ovan).</span><span class="sxs-lookup"><span data-stu-id="f66ba-426">In the device framework of the Audio device, the PID/VID are stored in the device descriptor (see the device descriptor declared above).</span></span>

<span data-ttu-id="f66ba-427">När ett USB-värdnamn identifierar USB-ljudenheten och monterar klassen Audio, kan enheten användas med valfri ljuds pelare eller inspelning (beroende på ramverket).</span><span class="sxs-lookup"><span data-stu-id="f66ba-427">When a USB host system discovers the USB Audio device and mounts the audio class, the device can be used with any audio player or recorder (depending on the framework).</span></span> <span data-ttu-id="f66ba-428">Se värd operativ systemet för referens.</span><span class="sxs-lookup"><span data-stu-id="f66ba-428">See the host Operating System for reference.</span></span>

<span data-ttu-id="f66ba-429">Ljud klassens API: er definieras nedan.</span><span class="sxs-lookup"><span data-stu-id="f66ba-429">The Audio class APIs are defined below.</span></span>

## <a name="ux_device_class_audio_read_thread_entry"></a><span data-ttu-id="f66ba-430">ux_device_class_audio_read_thread_entry</span><span class="sxs-lookup"><span data-stu-id="f66ba-430">ux_device_class_audio_read_thread_entry</span></span>

<span data-ttu-id="f66ba-431">Tråd inmatning för läsning av data för ljud funktionen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-431">Thread entry for reading data for the Audio function.</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-432">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-432">Prototype</span></span>

```C
VOID ux_device_class_audio_read_thread_entry(ULONG audio_stream);
```

### <a name="description"></a><span data-ttu-id="f66ba-433">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-433">Description</span></span>

<span data-ttu-id="f66ba-434">Den här funktionen skickas till initierings parametern för ljud strömmen om du vill läsa ljud från värden.</span><span class="sxs-lookup"><span data-stu-id="f66ba-434">This function is passed to the audio stream initialization parameter if reading audio from the host is desired.</span></span> <span data-ttu-id="f66ba-435">Internt skapas en tråd med den här funktionen som dess post funktion. själva tråden läser ljud data genom den isokrona slut punkten i ljud funktionen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-435">Internally, a thread is created with this function as its entry function; the thread itself reads audio data through the isochronous OUT endpoint in the Audio function.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-436">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-436">Parameters</span></span>

- <span data-ttu-id="f66ba-437">**audio_stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-437">**audio_stream**: Pointer to the audio stream instance.</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-438">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-438">Example</span></span>
...
## <a name="ux_device_class_audio_write_thread_entry"></a><span data-ttu-id="f66ba-439">ux_device_class_audio_write_thread_entry</span><span class="sxs-lookup"><span data-stu-id="f66ba-439">ux_device_class_audio_write_thread_entry</span></span>

<span data-ttu-id="f66ba-440">Tråd inmatning för att skriva data för ljud funktionen</span><span class="sxs-lookup"><span data-stu-id="f66ba-440">Thread entry for writing data for the Audio function</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-441">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-441">Prototype</span></span>

```C
VOID ux_device_class_audio_write_thread_entry(ULONG audio_stream);
```

### <a name="description"></a><span data-ttu-id="f66ba-442">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-442">Description</span></span>

<span data-ttu-id="f66ba-443">Den här funktionen skickas till initierings parametern för ljud strömmen om du vill skriva ljud till värden.</span><span class="sxs-lookup"><span data-stu-id="f66ba-443">This function is passed to the audio stream initialization parameter if writing audio to the host is desired.</span></span> <span data-ttu-id="f66ba-444">Internt skapas en tråd med den här funktionen som dess post funktion. själva tråden skriver ljud data via den isokrona slut punkten i ljud funktionen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-444">Internally, a thread is created with this function as its entry function; the thread itself writes audio data through the isochronous IN endpoint in the Audio function.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-445">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-445">Parameters</span></span>

- <span data-ttu-id="f66ba-446">**audio_stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-446">**audio_stream**: Pointer to the audio stream instance.</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-447">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-447">Example</span></span>
...
## <a name="ux_device_class_audio_stream_get"></a><span data-ttu-id="f66ba-448">ux_device_class_audio_stream_get</span><span class="sxs-lookup"><span data-stu-id="f66ba-448">ux_device_class_audio_stream_get</span></span>

<span data-ttu-id="f66ba-449">Hämta en speciell Stream-instans för ljud funktionen</span><span class="sxs-lookup"><span data-stu-id="f66ba-449">Get specific stream instance for the Audio function</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-450">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-450">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-451">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-451">Description</span></span>

<span data-ttu-id="f66ba-452">Den här funktionen används för att hämta en strömmande instans av klassen Audio.</span><span class="sxs-lookup"><span data-stu-id="f66ba-452">This function is used to get a stream instance of audio class.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-453">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-453">Parameters</span></span>

- <span data-ttu-id="f66ba-454">**ljud**: pekar mot ljud instansen</span><span class="sxs-lookup"><span data-stu-id="f66ba-454">**audio**: Pointer to the audio instance</span></span>
- <span data-ttu-id="f66ba-455">**stream_index**: Stream instance index baserat på 0</span><span class="sxs-lookup"><span data-stu-id="f66ba-455">**stream_index**: Stream instance index based on 0</span></span>
- <span data-ttu-id="f66ba-456">**Stream**: pekare till buffer för att lagra pekaren för ljud strömmens instans</span><span class="sxs-lookup"><span data-stu-id="f66ba-456">**stream**: Pointer to buffer to store the audio stream instance pointer</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-457">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-457">Return Value</span></span>

- <span data-ttu-id="f66ba-458">**UX_SUCCESS** (0X00) den här åtgärden lyckades</span><span class="sxs-lookup"><span data-stu-id="f66ba-458">**UX_SUCCESS** (0x00) This operation was successful</span></span>
- <span data-ttu-id="f66ba-459">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-459">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-460">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-460">Example</span></span>
...
## <a name="ux_device_class_audio_reception_start"></a><span data-ttu-id="f66ba-461">ux_device_class_audio_reception_start</span><span class="sxs-lookup"><span data-stu-id="f66ba-461">ux_device_class_audio_reception_start</span></span>

<span data-ttu-id="f66ba-462">Starta mottagning av ljud data för ljud strömmen</span><span class="sxs-lookup"><span data-stu-id="f66ba-462">Start audio data reception for the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-463">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-463">Prototype</span></span>

```C
UINT ux_device_class_audio_reception_start(UX_DEVICE_CLASS_AUDIO_STREAM *stream);
```

### <a name="description"></a><span data-ttu-id="f66ba-464">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-464">Description</span></span>

<span data-ttu-id="f66ba-465">Den här funktionen används för att starta läsning av ljud data i ljud strömmar.</span><span class="sxs-lookup"><span data-stu-id="f66ba-465">This function is used to start audio data reading in audio streams.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-466">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-466">Parameters</span></span>

- <span data-ttu-id="f66ba-467">**Stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-467">**stream**: Pointer to the audio stream instance.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-468">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-468">Return Value</span></span>

- <span data-ttu-id="f66ba-469">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-469">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-470">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) gränssnittet är nere.</span><span class="sxs-lookup"><span data-stu-id="f66ba-470">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="f66ba-471">**UX_BUFFER_OVERFLOW** (0X5D) FIFO-bufferten är full.</span><span class="sxs-lookup"><span data-stu-id="f66ba-471">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is full.</span></span>
- <span data-ttu-id="f66ba-472">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-472">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-473">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-473">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read8"></a><span data-ttu-id="f66ba-474">ux_device_class_audio_sample_read8</span><span class="sxs-lookup"><span data-stu-id="f66ba-474">ux_device_class_audio_sample_read8</span></span>

<span data-ttu-id="f66ba-475">Läs 8-bitars exempel från ljud strömmen</span><span class="sxs-lookup"><span data-stu-id="f66ba-475">Read 8-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-476">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-476">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-477">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-477">Description</span></span>

<span data-ttu-id="f66ba-478">Den här funktionen läser 8-bitars ljud exempel data från den angivna data strömmen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-478">This function reads 8-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="f66ba-479">Mer specifikt läser det exempel data från den aktuella bufferten för bild ramar i FIFO-enheten.</span><span class="sxs-lookup"><span data-stu-id="f66ba-479">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="f66ba-480">När du läser det sista exemplet i en ljud ram frigörs ramen automatiskt så att den kan användas för att acceptera mer data från värden.</span><span class="sxs-lookup"><span data-stu-id="f66ba-480">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-481">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-481">Parameters</span></span>

- <span data-ttu-id="f66ba-482">**Stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-482">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="f66ba-483">**Buffer**: pekar mot bufferten för att spara exempel-byte.</span><span class="sxs-lookup"><span data-stu-id="f66ba-483">**buffer**: Pointer to the buffer to save sample byte.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-484">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-484">Return Value</span></span>

- <span data-ttu-id="f66ba-485">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-485">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-486">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) gränssnittet är nere.</span><span class="sxs-lookup"><span data-stu-id="f66ba-486">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="f66ba-487">**UX_BUFFER_OVERFLOW** (0X5D) FIFO-bufferten är null.</span><span class="sxs-lookup"><span data-stu-id="f66ba-487">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="f66ba-488">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-488">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-489">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-489">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read16"></a><span data-ttu-id="f66ba-490">ux_device_class_audio_sample_read16</span><span class="sxs-lookup"><span data-stu-id="f66ba-490">ux_device_class_audio_sample_read16</span></span>

<span data-ttu-id="f66ba-491">Läsa 16-bitars exempel från ljud strömmen</span><span class="sxs-lookup"><span data-stu-id="f66ba-491">Read 16-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-492">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-492">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-493">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-493">Description</span></span>

<span data-ttu-id="f66ba-494">Den här funktionen läser 16-bitars ljud exempel data från den angivna data strömmen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-494">This function reads 16-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="f66ba-495">Mer specifikt läser det exempel data från den aktuella bufferten för bild ramar i FIFO-enheten.</span><span class="sxs-lookup"><span data-stu-id="f66ba-495">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="f66ba-496">När du läser det sista exemplet i en ljud ram frigörs ramen automatiskt så att den kan användas för att acceptera mer data från värden.</span><span class="sxs-lookup"><span data-stu-id="f66ba-496">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-497">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-497">Parameters</span></span>

- <span data-ttu-id="f66ba-498">**Stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-498">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="f66ba-499">**Buffer**: pekare till bufferten för att spara 16-bitars exemplet.</span><span class="sxs-lookup"><span data-stu-id="f66ba-499">**buffer**: Pointer to the buffer to save the 16-bit sample.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-500">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-500">Return Value</span></span>

- <span data-ttu-id="f66ba-501">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-501">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-502">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) gränssnittet är nere.</span><span class="sxs-lookup"><span data-stu-id="f66ba-502">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="f66ba-503">**UX_BUFFER_OVERFLOW** (0X5D) FIFO-bufferten är null.</span><span class="sxs-lookup"><span data-stu-id="f66ba-503">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="f66ba-504">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-504">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-505">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-505">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read24"></a><span data-ttu-id="f66ba-506">ux_device_class_audio_sample_read24</span><span class="sxs-lookup"><span data-stu-id="f66ba-506">ux_device_class_audio_sample_read24</span></span>

<span data-ttu-id="f66ba-507">Läs 24-bitars exempel från ljud strömmen</span><span class="sxs-lookup"><span data-stu-id="f66ba-507">Read 24-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-508">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-508">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-509">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-509">Description</span></span>

<span data-ttu-id="f66ba-510">Den här funktionen läser 24-bitars ljud exempel data från den angivna data strömmen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-510">This function reads 24-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="f66ba-511">Mer specifikt läser det exempel data från den aktuella bufferten för bild ramar i FIFO-enheten.</span><span class="sxs-lookup"><span data-stu-id="f66ba-511">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="f66ba-512">När du läser det sista exemplet i en ljud ram frigörs ramen automatiskt så att den kan användas för att acceptera mer data från värden.</span><span class="sxs-lookup"><span data-stu-id="f66ba-512">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-513">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-513">Parameters</span></span>

- <span data-ttu-id="f66ba-514">**Stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-514">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="f66ba-515">**Buffer**: pekare till bufferten för att spara exemplet med tre byte.</span><span class="sxs-lookup"><span data-stu-id="f66ba-515">**buffer**: Pointer to the buffer to save the 3-byte sample.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-516">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-516">Return Value</span></span>

- <span data-ttu-id="f66ba-517">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-517">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-518">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) gränssnittet är nere.</span><span class="sxs-lookup"><span data-stu-id="f66ba-518">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="f66ba-519">**UX_BUFFER_OVERFLOW** (0X5D) FIFO-bufferten är null.</span><span class="sxs-lookup"><span data-stu-id="f66ba-519">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="f66ba-520">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-520">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-521">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-521">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read32"></a><span data-ttu-id="f66ba-522">ux_device_class_audio_sample_read32</span><span class="sxs-lookup"><span data-stu-id="f66ba-522">ux_device_class_audio_sample_read32</span></span>

<span data-ttu-id="f66ba-523">Läs 32-bitars exempel från ljud strömmen</span><span class="sxs-lookup"><span data-stu-id="f66ba-523">Read 32-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-524">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-524">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-525">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-525">Description</span></span>

<span data-ttu-id="f66ba-526">Den här funktionen läser 32-bitars ljud exempel data från den angivna data strömmen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-526">This function reads 32-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="f66ba-527">Mer specifikt läser det exempel data från den aktuella bufferten för bild ramar i FIFO-enheten.</span><span class="sxs-lookup"><span data-stu-id="f66ba-527">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="f66ba-528">När du läser det sista exemplet i en ljud ram frigörs ramen automatiskt så att den kan användas för att acceptera mer data från värden.</span><span class="sxs-lookup"><span data-stu-id="f66ba-528">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-529">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-529">Parameters</span></span>

- <span data-ttu-id="f66ba-530">**Stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-530">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="f66ba-531">**Buffer**: pekar mot bufferten för att spara data för 4 byte.</span><span class="sxs-lookup"><span data-stu-id="f66ba-531">**buffer**: Pointer to the buffer to save the 4-byte data.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-532">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-532">Return Value</span></span>

- <span data-ttu-id="f66ba-533">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-533">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-534">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) gränssnittet är nere.</span><span class="sxs-lookup"><span data-stu-id="f66ba-534">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="f66ba-535">**UX_BUFFER_OVERFLOW** (0X5D) FIFO-bufferten är null.</span><span class="sxs-lookup"><span data-stu-id="f66ba-535">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="f66ba-536">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-536">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-537">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-537">Example</span></span>
...
## <a name="ux_device_class_audio_read_frame_get"></a><span data-ttu-id="f66ba-538">ux_device_class_audio_read_frame_get</span><span class="sxs-lookup"><span data-stu-id="f66ba-538">ux_device_class_audio_read_frame_get</span></span>

<span data-ttu-id="f66ba-539">Få åtkomst till ljud ramen i ljud strömmen</span><span class="sxs-lookup"><span data-stu-id="f66ba-539">Get access to audio frame in the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-540">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-540">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-541">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-541">Description</span></span>

<span data-ttu-id="f66ba-542">Den här funktionen returnerar den första ljud Rams bufferten och dess längd i den angivna data strömens FIFO.</span><span class="sxs-lookup"><span data-stu-id="f66ba-542">This function returns the first audio frame buffer and its length in the specified stream's FIFO.</span></span> <span data-ttu-id="f66ba-543">När programmet har behandlat data måste ux_device_class_audio_read_frame_free användas för att frigöra bildruteproportioner i FIFO.</span><span class="sxs-lookup"><span data-stu-id="f66ba-543">When the application is done processing the data, ux_device_class_audio_read_frame_free must be used to free the frame buffer in the FIFO.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-544">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-544">Parameters</span></span>

- <span data-ttu-id="f66ba-545">**Stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-545">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="f66ba-546">**frame_data**: pekar på data pekare för att returnera data pekaren i.</span><span class="sxs-lookup"><span data-stu-id="f66ba-546">**frame_data**: Pointer to data pointer to return the data pointer in.</span></span>
- <span data-ttu-id="f66ba-547">**frame_length**: pekare till buffer för att spara ram längden i antal byte.</span><span class="sxs-lookup"><span data-stu-id="f66ba-547">**frame_length**: Pointer to buffer to save the frame length in number of bytes.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-548">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-548">Return Value</span></span>

- <span data-ttu-id="f66ba-549">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-549">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-550">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) gränssnittet är nere.</span><span class="sxs-lookup"><span data-stu-id="f66ba-550">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="f66ba-551">**UX_BUFFER_OVERFLOW** (0X5D) FIFO-bufferten är null.</span><span class="sxs-lookup"><span data-stu-id="f66ba-551">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="f66ba-552">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-552">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-553">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-553">Example</span></span>
...
## <a name="ux_device_class_audio_read_frame_free"></a><span data-ttu-id="f66ba-554">ux_device_class_audio_read_frame_free</span><span class="sxs-lookup"><span data-stu-id="f66ba-554">ux_device_class_audio_read_frame_free</span></span>

<span data-ttu-id="f66ba-555">Frigör en buffert i ljud fönstret i ljud strömmen</span><span class="sxs-lookup"><span data-stu-id="f66ba-555">Free an audio frame buffer in Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-556">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-556">Prototype</span></span>

```C
UINT ux_device_class_audio_read_frame_free(UX_DEVICE_CLASS_AUDIO_STREAM *stream);
```

### <a name="description"></a><span data-ttu-id="f66ba-557">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-557">Description</span></span>

<span data-ttu-id="f66ba-558">Med den här funktionen frigörs ljud bildens buffert längst fram i den angivna data strömmens FIFO så att den kan ta emot data från värden.</span><span class="sxs-lookup"><span data-stu-id="f66ba-558">This function frees the audio frame buffer at the front of the specified stream's FIFO so that it can receive data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-559">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-559">Parameters</span></span>

- <span data-ttu-id="f66ba-560">**Stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-560">**stream**: Pointer to the audio stream instance.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-561">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-561">Return Value</span></span>

- <span data-ttu-id="f66ba-562">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-562">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-563">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) gränssnittet är nere.</span><span class="sxs-lookup"><span data-stu-id="f66ba-563">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="f66ba-564">**UX_BUFFER_OVERFLOW** (0X5D) FIFO-bufferten är null.</span><span class="sxs-lookup"><span data-stu-id="f66ba-564">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="f66ba-565">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-565">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-566">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-566">Example</span></span>
...
## <a name="ux_device_class_audio_transmission_start"></a><span data-ttu-id="f66ba-567">ux_device_class_audio_transmission_start</span><span class="sxs-lookup"><span data-stu-id="f66ba-567">ux_device_class_audio_transmission_start</span></span>

<span data-ttu-id="f66ba-568">Starta ljud data överföring för ljud strömmen</span><span class="sxs-lookup"><span data-stu-id="f66ba-568">Start audio data transmission for the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-569">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-569">Prototype</span></span>

```C
UINT ux_device_class_audio_transmission_start(UX_DEVICE_CLASS_AUDIO_STREAM *stream);
```

### <a name="description"></a><span data-ttu-id="f66ba-570">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-570">Description</span></span>

<span data-ttu-id="f66ba-571">Den här funktionen används för att börja skicka ljud data som skrivits till FIFO i klassen Audio.</span><span class="sxs-lookup"><span data-stu-id="f66ba-571">This function is used to start sending audio data written to the FIFO in the audio class.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-572">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-572">Parameters</span></span>

- <span data-ttu-id="f66ba-573">**Stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-573">**stream**: Pointer to the audio stream instance.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-574">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-574">Return Value</span></span>

- <span data-ttu-id="f66ba-575">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-575">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-576">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) gränssnittet är nere.</span><span class="sxs-lookup"><span data-stu-id="f66ba-576">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="f66ba-577">**UX_BUFFER_OVERFLOW** (0X5D) FIFO-bufferten är null.</span><span class="sxs-lookup"><span data-stu-id="f66ba-577">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="f66ba-578">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-578">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-579">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-579">Example</span></span>
...
## <a name="ux_device_class_audio_frame_write"></a><span data-ttu-id="f66ba-580">ux_device_class_audio_frame_write</span><span class="sxs-lookup"><span data-stu-id="f66ba-580">ux_device_class_audio_frame_write</span></span>

<span data-ttu-id="f66ba-581">Skriv en ljud bild ruta i ljud strömmen</span><span class="sxs-lookup"><span data-stu-id="f66ba-581">Write an audio frame into the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-582">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-582">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-583">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-583">Description</span></span>

<span data-ttu-id="f66ba-584">Den här funktionen skriver en ram till ljud strömmens FIFO.</span><span class="sxs-lookup"><span data-stu-id="f66ba-584">This function writes a frame to the audio stream's FIFO.</span></span> <span data-ttu-id="f66ba-585">Ramdata kopieras till den tillgängliga bufferten i FIFO så att den kan skickas till värden.</span><span class="sxs-lookup"><span data-stu-id="f66ba-585">The frame data is copied to the available buffer in the FIFO so that it can be sent to the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-586">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-586">Parameters</span></span>

- <span data-ttu-id="f66ba-587">**Stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-587">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="f66ba-588">**ram**: pekar mot ramdata.</span><span class="sxs-lookup"><span data-stu-id="f66ba-588">**frame**: Pointer to frame data.</span></span>
- <span data-ttu-id="f66ba-589">**frame_length** Ram längd i antal byte.</span><span class="sxs-lookup"><span data-stu-id="f66ba-589">**frame_length** Frame length in number of bytes.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-590">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-590">Return Value</span></span>

- <span data-ttu-id="f66ba-591">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-591">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-592">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) gränssnittet är nere.</span><span class="sxs-lookup"><span data-stu-id="f66ba-592">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="f66ba-593">**UX_BUFFER_OVERFLOW** (0X5D) FIFO-bufferten är full.</span><span class="sxs-lookup"><span data-stu-id="f66ba-593">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is full.</span></span>
- <span data-ttu-id="f66ba-594">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-594">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-595">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-595">Example</span></span>
...
## <a name="ux_device_class_audio_write_frame_get"></a><span data-ttu-id="f66ba-596">ux_device_class_audio_write_frame_get</span><span class="sxs-lookup"><span data-stu-id="f66ba-596">ux_device_class_audio_write_frame_get</span></span>

<span data-ttu-id="f66ba-597">Få åtkomst till ljud ramen i ljud strömmen</span><span class="sxs-lookup"><span data-stu-id="f66ba-597">Get access to audio frame in the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-598">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-598">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-599">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-599">Description</span></span>

<span data-ttu-id="f66ba-600">Den här funktionen hämtar adressen till den senaste ljud bildens buffert i FIFOn. den hämtar också längden på ljud Rams bufferten.</span><span class="sxs-lookup"><span data-stu-id="f66ba-600">This function retrieves the address of the last audio frame buffer of the FIFO; it also retrieves the length of the audio frame buffer.</span></span> <span data-ttu-id="f66ba-601">När programmet har fyllt i ljud fönstrets buffert med önskade data, måste ***ux_device_class_audio_write_frame_commit*** användas för att lägga till/bekräfta RAMSIDAN till FIFO.</span><span class="sxs-lookup"><span data-stu-id="f66ba-601">After the application fills the audio frame buffer with its desired data, ***ux_device_class_audio_write_frame_commit*** must be used to add/commit the frame buffer to the FIFO.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-602">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-602">Parameters</span></span>

- <span data-ttu-id="f66ba-603">**Stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-603">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="f66ba-604">**frame_data**: pekar mot bildruta-datapekare för att returnera ramens data pekare i.</span><span class="sxs-lookup"><span data-stu-id="f66ba-604">**frame_data**: Pointer to frame data pointer to return the frame data pointer in.</span></span>
- <span data-ttu-id="f66ba-605">**frame_length** Pekar på bufferten för att spara ram längden i antal byte.</span><span class="sxs-lookup"><span data-stu-id="f66ba-605">**frame_length** Pointer to the buffer to save frame length in number of bytes .</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-606">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-606">Return Value</span></span>

- <span data-ttu-id="f66ba-607">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-607">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-608">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) gränssnittet är nere.</span><span class="sxs-lookup"><span data-stu-id="f66ba-608">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="f66ba-609">**UX_BUFFER_OVERFLOW** (0X5D) FIFO-bufferten är full.</span><span class="sxs-lookup"><span data-stu-id="f66ba-609">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is full.</span></span>
- <span data-ttu-id="f66ba-610">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-610">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-611">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-611">Example</span></span>
...
## <a name="ux_device_class_audio_write_frame_commit"></a><span data-ttu-id="f66ba-612">ux_device_class_audio_write_frame_commit</span><span class="sxs-lookup"><span data-stu-id="f66ba-612">ux_device_class_audio_write_frame_commit</span></span>

<span data-ttu-id="f66ba-613">Bekräfta en buffert för ljud ramar i ljud strömmen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-613">Commit an audio frame buffer in Audio stream.</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-614">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-614">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-615">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-615">Description</span></span>

<span data-ttu-id="f66ba-616">Den här funktionen lägger till/aktiverar den senaste ljud bildens buffert till FIFO så att bufferten kan överföras till värden. Observera att den sista bufferten för ljud ramar borde ha fyllts i via ux_device_class_write_frame_get.</span><span class="sxs-lookup"><span data-stu-id="f66ba-616">This function adds/commits the last audio frame buffer to the FIFO so the buffer is ready to be transferred to host; note the last audio frame buffer should have been filled out via ux_device_class_write_frame_get.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-617">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-617">Parameters</span></span>

- <span data-ttu-id="f66ba-618">**Stream**: pekar mot ljud Ströms instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-618">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="f66ba-619">**längd**: antal byte som är klara i bufferten.</span><span class="sxs-lookup"><span data-stu-id="f66ba-619">**length**: Number of bytes ready in the buffer.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-620">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-620">Return Value</span></span>

- <span data-ttu-id="f66ba-621">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-621">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-622">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) gränssnittet är nere.</span><span class="sxs-lookup"><span data-stu-id="f66ba-622">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="f66ba-623">**UX_BUFFER_OVERFLOW** (0X5D) FIFO-bufferten är fssull.</span><span class="sxs-lookup"><span data-stu-id="f66ba-623">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is fssull.</span></span>
- <span data-ttu-id="f66ba-624">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-624">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-625">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-625">Example</span></span>
...
## <a name="ux_device_class_audio10_control_process"></a><span data-ttu-id="f66ba-626">ux_device_class_audio10_control_process</span><span class="sxs-lookup"><span data-stu-id="f66ba-626">ux_device_class_audio10_control_process</span></span>

<span data-ttu-id="f66ba-627">Bearbeta USB-ljud 1,0-kontroll begär Anden</span><span class="sxs-lookup"><span data-stu-id="f66ba-627">Process USB Audio 1.0 control requests</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-628">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-628">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="f66ba-629">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-629">Description</span></span>

<span data-ttu-id="f66ba-630">Den här funktionen hanterar grundläggande förfrågningar som skickas av värden på kontrollens slut punkt med en USB-ljud1,0-typ.</span><span class="sxs-lookup"><span data-stu-id="f66ba-630">This function manages basic requests sent by the host on the control endpoint with a USB Audio 1.0 specific type.</span></span>

<span data-ttu-id="f66ba-631">Ljud 1,0 funktioner för volym-och ljud uppspelnings förfrågningar bearbetas i funktionen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-631">Audio 1.0 features of volume and mute requests are processed in the function.</span></span> <span data-ttu-id="f66ba-632">När begär Anden bearbetas används fördefinierade data som skickas av den senaste parametern (grupp) för att besvara begär Anden och spara kontroll ändringar.</span><span class="sxs-lookup"><span data-stu-id="f66ba-632">When processing the requests, pre-defined data passed by the last parameter (group) is used to answer requests and store control changes.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-633">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-633">Parameters</span></span>

- <span data-ttu-id="f66ba-634">**ljud**: pekar mot ljud instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-634">**audio**: Pointer to the audio instance.</span></span>
- <span data-ttu-id="f66ba-635">**överföring**: pekar mot överförings begär ande instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-635">**transfer**: Pointer to the transfer request instance.</span></span>
- <span data-ttu-id="f66ba-636">**grupp**: data grupp för process för begäran.</span><span class="sxs-lookup"><span data-stu-id="f66ba-636">**group**: Data group for request process.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-637">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-637">Return Value</span></span>

- <span data-ttu-id="f66ba-638">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-638">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-639">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-639">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-640">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-640">Example</span></span>
...
## <a name="ux_device_class_audio20_control_process"></a><span data-ttu-id="f66ba-641">ux_device_class_audio20_control_process</span><span class="sxs-lookup"><span data-stu-id="f66ba-641">ux_device_class_audio20_control_process</span></span>

<span data-ttu-id="f66ba-642">Bearbeta USB-ljud 1,0-kontroll begär Anden</span><span class="sxs-lookup"><span data-stu-id="f66ba-642">Process USB Audio 1.0 control requests</span></span>

### <a name="prototype"></a><span data-ttu-id="f66ba-643">Prototyp</span><span class="sxs-lookup"><span data-stu-id="f66ba-643">Prototype</span></span>
```C
...
### <a name="description"></a><span data-ttu-id="f66ba-644">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="f66ba-644">Description</span></span>

<span data-ttu-id="f66ba-645">Den här funktionen hanterar grundläggande förfrågningar som skickas av värden på kontrollens slut punkt med en USB-ljud2,0-typ.</span><span class="sxs-lookup"><span data-stu-id="f66ba-645">This function manages basic requests sent by the host on the control endpoint with a USB Audio 2.0 specific type.</span></span>

<span data-ttu-id="f66ba-646">Ljud 2,0 samplings frekvens (förmodad enkel fast frekvens), funktioner för volym och ljud av förfrågningar bearbetas i funktionen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-646">Audio 2.0 sampling rate (assumed single fixed frequency), features of volume and mute requests are processed in the function.</span></span> <span data-ttu-id="f66ba-647">När begär Anden bearbetas används fördefinierade data som skickas av den senaste parametern (grupp) för att besvara begär Anden och spara kontroll ändringar.</span><span class="sxs-lookup"><span data-stu-id="f66ba-647">When processing the requests, pre-defined data passed by the last parameter (group) is used to answer requests and store control changes.</span></span>

### <a name="parameters"></a><span data-ttu-id="f66ba-648">Parametrar</span><span class="sxs-lookup"><span data-stu-id="f66ba-648">Parameters</span></span>

- <span data-ttu-id="f66ba-649">**ljud**: pekar mot ljud instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-649">**audio**: Pointer to the audio instance.</span></span>
- <span data-ttu-id="f66ba-650">**överföring**: pekar mot överförings begär ande instansen.</span><span class="sxs-lookup"><span data-stu-id="f66ba-650">**transfer**: Pointer to the transfer request instance.</span></span>
- <span data-ttu-id="f66ba-651">**grupp**: data grupp för process för begäran.</span><span class="sxs-lookup"><span data-stu-id="f66ba-651">**group**: Data group for request process.</span></span>

### <a name="return-value"></a><span data-ttu-id="f66ba-652">Returvärde</span><span class="sxs-lookup"><span data-stu-id="f66ba-652">Return Value</span></span>

- <span data-ttu-id="f66ba-653">**UX_SUCCESS** (0X00) den här åtgärden lyckades.</span><span class="sxs-lookup"><span data-stu-id="f66ba-653">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="f66ba-654">**UX_ERROR** (0Xff) fel från funktion</span><span class="sxs-lookup"><span data-stu-id="f66ba-654">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="f66ba-655">Exempel</span><span class="sxs-lookup"><span data-stu-id="f66ba-655">Example</span></span>
