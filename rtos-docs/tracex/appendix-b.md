---
title: Bilaga B – filen tx_trace. h
description: I det här kapitlet visas filen tx_trace. h.
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104827828"
---
# <a name="appendix-b---the-tx_traceh-file"></a><span data-ttu-id="c6bae-103">Bilaga B – filen tx_trace. h</span><span class="sxs-lookup"><span data-stu-id="c6bae-103">Appendix B - The tx_trace.h file</span></span>

<span data-ttu-id="c6bae-104">I det här kapitlet visas filen **tx_trace. h** .</span><span class="sxs-lookup"><span data-stu-id="c6bae-104">This chapter displays the **tx_trace.h** file.</span></span>
