---
title: Kapitel 3 – Azure återställnings tider NetX BSD-tjänster
description: Det här kapitlet innehåller en beskrivning av alla Azure återställnings tider NetX BSD Basic-tjänster som listas nedan i alfabetisk ordning.
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104825599"
---
# <a name="chapter-3---azure-rtos-netx-bsd-services"></a><span data-ttu-id="598b8-103">Kapitel 3 – Azure återställnings tider NetX BSD-tjänster</span><span class="sxs-lookup"><span data-stu-id="598b8-103">Chapter 3 - Azure RTOS NetX BSD Services</span></span>

<span data-ttu-id="598b8-104">Det här kapitlet innehåller en beskrivning av alla Azure återställnings tider NetX BSD Basic-tjänster som listas nedan i alfabetisk ordning.</span><span class="sxs-lookup"><span data-stu-id="598b8-104">This chapter contains a description of all Azure RTOS NetX BSD basic services listed below in alphabetic order.</span></span>
