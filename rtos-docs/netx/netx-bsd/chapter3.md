---
title: Kapitel 3 – Azure RTOS NetX BSD Services
description: Det här kapitlet innehåller en beskrivning av alla Azure RTOS Grundläggande NetX BSD-tjänster som anges nedan i alfabetisk ordning.
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "116796794"
---
# <a name="chapter-3---azure-rtos-netx-bsd-services"></a>Kapitel 3 – Azure RTOS NetX BSD Services

Det här kapitlet innehåller en beskrivning av alla Azure RTOS Grundläggande NetX BSD-tjänster som anges nedan i alfabetisk ordning.
